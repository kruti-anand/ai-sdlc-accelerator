...
'build', 'develop', 'implement', 'create an application',
'create a system', 'software', 'app', 'application',
'api', 'integration', 'integrate', 'automation',
'database', 'platform', 'authentication', 'mfa',
'lambda', 'cloud', 'website', 'portal', 'system'
];

const processSignals = [
'process', 'workflow', 'procedure', 'approval',
'intake', 'operating model', 'business process',
'policy', 'review process', 'standardize'
];

const planningSignals = [
'plan', 'planning', 'trip', 'travel', 'itinerary',
'schedule', 'organize', 'arrange', 'visit',
'vacation', 'agenda', 'event'
];

const informationalSignals = [
'explain', 'what is', 'how does', 'tell me about',
'information about', 'research', 'compare', 'comparison'
];
...
$('#questions-list').innerHTML = state.questions.map((question, index) => `     <div class="question">       <label for="${question.id}">         <span class="question-index">${String(index + 1).padStart(2, '0')}</span>
...
$('#brd-content').innerHTML = ` <article class="brd-section"> <h3>1. Business objective</h3> <p>
Enable the organization to deliver the requested technology capability: <strong>${escapeHtml(req)}</strong>.
The objective is to address the stated business need while keeping
unresolved decisions visible. </p> </article>
...
<article class="brd-section">
  ...
  <ul>
    ...
    <li>Known technical constraints:
...
$('#brd-content').innerHTML = ` <article class="brd-section"> <h3>1. Business objective</h3> <p>
Establish or improve a business process that addresses: <strong>${escapeHtml(req)}</strong>. </p> </article>
...
<article class="brd-section">
  ...
  <ul>
    <li><strong>Current state:</strong>
      ${valueOrAssumption('current', 'Current workflow has not yet been documented.')}
    </li>
    <li><strong>Desired outcome:</strong>
      ${valueOrAssumption('outcome', 'Desired future state requires confirmation.')}
    </li>
  </ul>
</article>
...
$('#brd-content').innerHTML = ` <article class="brd-section"> <h3>1. Desired outcome</h3> <p> <strong>${escapeHtml(req)}</strong> </p> <p>
${valueOrAssumption(
'outcome',
...
$('#brd-content').innerHTML = ` <article class="brd-section"> <h3>1. Objective</h3> <p><strong>${escapeHtml(req)}</strong></p> <p>
${valueOrAssumption(
'objective',
